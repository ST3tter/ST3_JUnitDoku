...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\documentclass[version=last,fleqn,pointlessnumbers,twoside]{scrreprt}  %first: Ergebniss Kompatibel zu ersten Version; last: Ergebniss entspricht den aktuellen Paketen; fleqn: Formeln linksbündig; pointlessnumbers: Kapitelnummerierung ohne Punkt; twoside: Doppelseitiger Druck; openright = neues Kapitel auf rechter Seite

%Dokumentangaben
\newcommand{\Titel}{Unit-Testing mit JUnit}
\newcommand{\Uebertitel}{JUnit Tutorial}
%
\newcommand{\AutorA}{Tobias	Meerstetter}
%
\newcommand{\DozentA}{Peter Aeschimann}
%
\newcommand{\ExpertA}{Mario Giacometto}
%
...
%Kapitel: Unit-Testing
\input{content/unittesting/unittesting}
%Kapitel: JUnit
\input{content/junit/junit}
%Kapitel: Test erstellen
\input{content/testerstellen/testerstellen}
%Kapitel: EclEmma
\input{content/eclemma/eclemma}

%Kapitel: Schlussfolgerung
\input{content/schlusswort/schlusswort}
%
%
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%
%Anhang A
%\input{appendix/versionierung/versionierung}
%
%
%
%
